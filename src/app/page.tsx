...
export default function LandingPage() {
  ...
  return (
    <div className="flex h-fit w-full flex-col items-center">
      ...
      <p className="mt-6 w-9/12 text-center text-xs font-medium sm:mt-8 sm:w-8/12 sm:text-sm md:mt-10 md:text-lg xl:w-9/12 xl:px-10 xl:text-xl 2xl:w-3/4">
        {SUBTITLE}
      </p>

      <Button
        className="mt-12 h-auto px-8 py-3 text-xs sm:mt-16 md:mt-20 md:px-10 md:py-4 md:text-sm xl:px-12 xl:text-base"
        onClick={() => {
