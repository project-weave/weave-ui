...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    className={cn(
      "fixed right-0 top-0 z-[999] flex max-h-screen w-full flex-col-reverse p-4 md:bottom-0 md:top-auto md:max-w-[420px] md:flex-col",
      className
    )}
    ref={ref}
    {...props}
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity group-hover:opacity-100 group-[.failure]:text-failure group-[.success]:text-success hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-1 group-[.failure]:focus:ring-failure group-[.success]:focus:ring-success group-[.failure]:focus:ring-offset-red-600 group-[.success]:focus:ring-offset-green-600",
      className
    )}
    ref={ref}
    toast-close=""
